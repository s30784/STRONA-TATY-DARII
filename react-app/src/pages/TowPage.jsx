...
export function TowPage({ towMsg, submitTowRequest }) {
  return (
          ...
          <aside>
            <Card title="Szybka wycena lawety">
              ...
              <form onSubmit={submitTowRequest}>
                ...
                <button className="btn-primary" type="submit">Przygotuj zapytanie</button>
              </form>
            </Card>
          </aside>
        </div>
