export function HomePage({ showPage, currentUser, contactEmail }) {
  const services = [
  ...
  const trustBadges = ['Trasa Polska-Austria', 'Wynajem busów', 'Transport lawetą', 'Rezerwacje online'];
  const trustItems = [
    ...
    <div className="page active">
      <section className="home-hero">
        <div className="home-hero-inner">
          <div className="hero-kicker">Transport premium z Jarosławia</div>
          ...
          <div className="hero-contact">
            Kontakt bezpośredni: <a href={`mailto:${contactEmail}`}>{contactEmail}</a>
